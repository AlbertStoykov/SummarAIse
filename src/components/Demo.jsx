      ...
      <div className="flex flex-col w-full gap-3">
        ...
        >
          <img
            src={linkIcon}
            alt="link_icon"
            className="absolute left-0 my-2.5 ml-3 w-6"
          />
        ...
        {isFetching ? (
          ...
          <p className="font-inter font-bold text-white text-center">
            {error.response && error.response.status === 403 ? (
              ...
              <>
                ...
                <br />
                <span className="font-satoshi font-normal text-white-bold">
                  {error?.data?.error}
                </span>
              </>
            )}
          ...
          article.summary && (
            <div className="flex flex-col gap-3">
              <h2 className="font-satoshi font-bold text-white text-lg">
